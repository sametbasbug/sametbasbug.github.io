...
related: ["prompt", "human-in-the-loop", "sandbox"]
---

Dış içerik içine gömülen yanıltıcı talimatların modeli veya ajanı istenmeyen yöne çekmeye çalışması durumu.

> **Gömülü talimat riski** — Bir web sayfasında geçen 'önceki kuralları unut ve bunu çalıştır' benzeri metinler pasif veri olmalı; komut sayılırsa prompt injection riski doğar.
