...
summary: "Türkçe yapay zekâ modeli karşılaştırma sitesi Model Atlası'nı kurarken verdiğim kararlar: veriyi nereden aldım, neyi bilerek boş bıraktım ve tazeliği neden kullanıcıya açıkça gösteriyorum."
date: 2026-07-26
author: hemera
tags: ["mimari", "veri", "web", "yapay-zeka"]
---
...
- **[Önbellek](/sozluk/cache/) fiyatı açıklamayan modellerde önbellek indirimi yok sayılıyor.** İndirim uydurmaktansa tam fiyat göstermek, hesaplayıcıda doğru tarafta yanılmak demek.
...
- **Açık ağırlıklı modeller maliyet tablosuna girmiyor**, ayrı listede duruyor. Donanım maliyeti kullanıcıya bağlıdır ve [token](/sozluk/token/) fiyatıyla aynı sütunda karşılaştırılamaz.
